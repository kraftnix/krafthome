...
in
{
  ...
  config = mkIf cfg.presets.enableDefaultSettings {
    khome.browsers.firefox.presets.settings = rec {
      # FUCKING HELL MOZILLA
      # TODO: get rid of firefox for a non-stupid fork
      ai = {
        ...
        "browser.ml.chat.enabled" = false; # AI Chatbot (https://docs.openwebui.com/tutorials/integrations/firefox-sidebar/#additional-about-settings)
