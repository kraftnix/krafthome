    ...
    "['<leader>']" = {
      g = {
        ...
        d = {
          ...
          g = [":Gdiff " "Git diff (select your branch)"];
        };

        # Remote / Branching
        r = [":Git rebase --interactive<Space>" "Interactive rebase"];
        R = [":Git rebase " "Open rebase command"];
        o = [":Git checkout " "Open Checkout command"];
        O = [":Git branch " "Open Branch command"];
        ...
        p = {
          ...
          p = cmd "Git pull" "Pull";
          P = cmd "Git push" "Push";
          u = [":Git pull upstream " "Pull upstream (complete)"];
          U = [":Git push upstream " "Push upstream (complete)"];
          o = [":Git pull origin " "Pull origin (complete)"];
          O = [":Git push origin " "Push origin (complete)"];
          f = ["<CMD>lua vim.cmd('Git push -u origin '..GitCurrentBranchName())<CR>" "Push origin for first time, same name"];
        };
      };
    };
  };
