  ...
  _internal.which-key.telescope = {
    "['<leader>']" = {
      ...
      f = {
        ...
        F = cmd "lua require'telescope.builtin'.live_grep {default_text='function'}" "grep for functions only";
        ...
        "['~']" = cmd "lua require'telescope.builtin'.find_files({ search_dirs={'~'} })" "Search files in home directory";
        "['.']" = cmd "lua require'telescope.builtin'.find_files({ search_dirs={getCurrDir()} })" "Search files in home directory";
